...
# Bot information *
SESSION = environ.get('SESSION', 'the_name_is_lazydeveloper')
...
DONATION_LINK = environ.get("DONATION_LINK","https://razorpay.me/@digitalonlineservices")
...
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', '92fd0a4f70ac7b0d3bb773db3a36c01bc07de6c8')
...
LAZY_SHORTNER_URL = environ.get('LAZY_SHORTNER_URL', 'digital-online-services.in')
