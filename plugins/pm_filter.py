...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        vjlink = await get_vj_shortlink(f"https://t.me/{temp.U_NAME}?start={ident}_{file_id}", URL_SHORTENR_WEBSITE, URL_SHORTNER_WEBSITE_API)
        ...
        buttons = [[
                    ...
                    [
                    InlineKeyboardButton('🍿 ᴜᴘᴅᴀᴛᴇs', url=f'https://t.me/'),
                    InlineKeyboardButton('🤖 ʙᴏᴛs', url=f'https://t.me/')
                    ],[
                    InlineKeyboardButton('🎬 ᴍᴏᴠɪᴇs', url=f'https://t.me/'),
